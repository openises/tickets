...
//if (!(empty($temp))) {
	...
	$user_acct =  	isset($temp_ar[2])? $temp_ar[2]:""; 
	$pass =  		isset($temp_ar[3])? $temp_ar[3]:""; 
//	}
?>
...
<TR CLASS="even"><TD>User account: </TD>		<TD><INPUT TYPE = 'text' NAME='user_acct'  	VALUE='<?php print $user_acct;?>' SIZE= 24><I> ex:ashore3</TD></TR>
<TR CLASS="odd"><TD>Password:  </TD>			<TD><INPUT TYPE = 'text' NAME='pass'  		VALUE='<?php print $pass;?>' SIZE= 12><I> ex:whatever</TD></TR>
</TABLE>
<BR />
<TABLE ALIGN = 'center' WIDTH='640px'>
<TR CLASS="even"><TD></TD><TD><H4>Enter your test message</H4></TD></TR>
<TR CLASS="odd"><TD>From name: </TD>			<TD><INPUT TYPE = 'text' NAME='from_user'	VALUE='' SIZE= 24><I> anything</I></TD></TR>
<TR CLASS="even"><TD>From address: </TD>		<TD><INPUT TYPE = 'text' NAME='from_addr'	VALUE='' SIZE= 24><I> a <B>valid</B> email address (your ISP's restriction may apply)</I></TD></TR>
<TR CLASS="odd"><TD>To address: </TD>			<TD><INPUT TYPE = 'text' NAME='to_addr'		VALUE='' SIZE= 24><I> a <B>valid</B> email address</I></TD></TR>
<TR CLASS="even"><TD>Subject:  </TD>			<TD><INPUT TYPE = 'text' NAME='subj'		VALUE='' SIZE= 24></TD></TR>
<TR CLASS="odd" VALIGN='top'><TD>Message:  	</TD><TD><TEXTAREA NAME='msg' cols=40 rows=2></TEXTAREA><BR /></TD></TR>
<TR CLASS="even"><TD COLSPAN=2 ALIGN='center'><INPUT TYPE = reset VALUE='Reset' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE = 'button' VALUE='Send' onClick = "validate()" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT TYPE = 'button' VALUE='Cancel' onClick = "self.close();"/></TD></TR>
</TABLE>
</FORM>
</BODY>
</HTML>
...
//	$fp = @fsockopen("outgoing.verizon.net", 587);
	if ($fp) {
		...
		$transport = Swift_SmtpTransport::newInstance(trim($_POST['server']) , trim($_POST['port']))
