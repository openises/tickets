...
function get_assigns_id($user_id, $ticket) {
	...
	$assigns_arr[2] = (($row['responding'] != "") && ($row['responding'] != NULL)) ? format_date_2(safe_strtotime($row['responding'])): "";
	$assigns_arr[3] = (($row['on_scene'] != "") && ($row['on_scene'] != NULL)) ? format_date_2(safe_strtotime($row['on_scene'])): "";
	$assigns_arr[4] = (($row['u2fenr'] != "") && ($row['u2fenr'] != NULL)) ? format_date_2(safe_strtotime($row['u2fenr'])): "";
	$assigns_arr[5] = (($row['u2farr'] != "") && ($row['u2farr'] != NULL)) ? format_date_2(safe_strtotime($row['u2farr'])): "";
	$assigns_arr[6] = (($row['clear'] != "") && ($row['clear'] != NULL)) ? format_date_2(safe_strtotime($row['clear'])): "";
...
if (!$row) {
	...
	$booked_date = (($row['booked_date'] != NULL) && ($row['booked_date'] != "0000-00-00 00:00:00")) ? format_date_2(safe_strtotime($row['booked_date'])) : "";
	...
	$print .= "<TD style='width: 20%; background-color: #CECECE; color: #000000;'>" . format_date_2(safe_strtotime($row['problemstart'])) . "</TD></TR>";	
	$print .= "<TR class='spacer'><TD colspan=99 class='spacer'>&nbsp;</TD></TR>";			
	$print .= "<TR style='width: 100%;'>";	
	$print .= "<TR style='width: 100%;'>";
	$print .= "<TD style='width: 30%; background-color: #000000; color: #FFFFFF; font-weight: bold;'>Updated</TD>";			
	$print .= "<TD style='width: 20%; background-color: #CECECE; color: #000000;'>" . format_date_2(safe_strtotime($row['updated'])) . "</TD></TR>";	
	$print .= "<TR class='spacer'><TD colspan=99 class='spacer'>&nbsp;</TD></TR>";			
	$print .= "<TR style='width: 100%;'>";		
