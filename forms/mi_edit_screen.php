...
?>
				...
				<TR CLASS = "even">
					...
					<TD CLASS='td_data text' COLSPAN=3>
						<TEXTAREA id='description' CLASS='td_data text' NAME="frm_descr" COLS=56 ROWS=5><?php print $row['description'];?></TEXTAREA>
					</TD>
				</TR>
				<TR CLASS = "odd">
					<TD CLASS="td_label text">
					...
					<TD CLASS='td_data text' COLSPAN=3 >
						<TEXTAREA id='notes' CLASS='td_data text' NAME="frm_notes" COLS=56 ROWS=5><?php print $row['incident_notes'];?></TEXTAREA>
					</TD>
				</TR>
				<TR class='spacer'>
