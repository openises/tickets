                    ...
                    <TD CLASS='td_data text'>
                        <SPAN style='width: 100%; display: block;'>
                            <SELECT id='gold' CLASS='text' NAME="frm_gold" onChange = "this.value=JSfnTrim(this.value); set_command_info(this.value, 'gold_command_data'); showtheDiv('gold_location_data');">    <!--  11/17/10 -->
                                <OPTION CLASS='text' VALUE=0>Select Gold Command</OPTION>
<?php
                                ...
                                $result_gold = db_query($query_gold);                                while ($row_gold = stripslashes_deep($result_gold->fetch_assoc())) {
                                    ...
                                    print "\t<OPTION CLASS='text' VALUE='" . $row_gold['id'] . "' " . $sel . ">" . $row_gold['user'] . " - " . $row_gold['name_f'] . " " . $row_gold['name_l'] . "</OPTION>\n";
                                    }
?>
                            </SELECT>
                        </SPAN>
...
?>
                                        ...
                                        <DIV style='width: 100%; display: inline-block; vertical-align: top;'>
                                            <INPUT id='gold_street' CLASS='td_data text' MAXLENGTH='64' SIZE='48' TYPE='text' NAME='frm_gold_street' VALUE='<?php print $gold_street;?>' /><BR />
                                            <INPUT id='gold_city' CLASS='td_data text' MAXLENGTH='64' SIZE='48' TYPE='text' NAME='frm_gold_city' VALUE='<?php print $gold_city;?>' /></BR>
                                            <INPUT id='gold_state' CLASS='td_data text' MAXLENGTH='4' SIZE='4' TYPE='text' NAME='frm_gold_state' VALUE='<?php print $gold_state;?>' />
                                            <INPUT TYPE='hidden' NAME='frm_gold_lat' VALUE='<?php print e($row['gold_lat']);?>'>
                                            <INPUT TYPE='hidden' NAME='frm_gold_lng' VALUE='<?php print e($row['gold_lng']);?>'>
                                        </DIV>
                                    </TD>
<?php
                                    }
...
?>
                                        ...
                                        <DIV style='width: 100%; display: inline-block; vertical-align: top;'>
                                            <INPUT id='silver_street' CLASS='td_data text' MAXLENGTH='64' SIZE='48' TYPE='text' NAME='frm_silver_street' VALUE='<?php print $silver_street;?>' /><BR />
                                            <INPUT id='silver_city' CLASS='td_data text' MAXLENGTH='64' SIZE='48' TYPE='text' NAME='frm_silver_city' VALUE='<?php print $silver_city;?>' /></BR>
                                            <INPUT id='silver_state' CLASS='td_data text' MAXLENGTH='4' SIZE='4' TYPE='text' NAME='frm_silver_state' VALUE='<?php print $silver_state;?>' />
                                            <INPUT TYPE='hidden' NAME='frm_silver_lat' VALUE='<?php print e($row['silver_lat']);?>'>
                                            <INPUT TYPE='hidden' NAME='frm_silver_lng' VALUE='<?php print e($row['silver_lng']);?>'>
                                        </DIV>
                                    </TD>
<?php
                                    }
...
?>
                                        ...
                                        <DIV style='width: 100%; display: inline-block; vertical-align: top;'>
                                            <INPUT id='bronze_street' CLASS='td_data text' MAXLENGTH='64' SIZE='48' TYPE='text' NAME='frm_bronze_street' VALUE='<?php print $bronze_street;?>' /><BR />
                                            <INPUT id='bronze_city' CLASS='td_data text' MAXLENGTH='64' SIZE='48' TYPE='text' NAME='frm_bronze_city' VALUE='<?php print $bronze_city;?>' /></BR>
                                            <INPUT id='bronze_state' CLASS='td_data text' MAXLENGTH='4' SIZE='4' TYPE='text' NAME='frm_bronze_state' VALUE='<?php print $bronze_state;?>' />
                                            <INPUT TYPE='hidden' NAME='frm_bronze_lat' VALUE='<?php print e($row['bronze_lat']);?>'>
                                            <INPUT TYPE='hidden' NAME='frm_bronze_lng' VALUE='<?php print e($row['bronze_lng']);?>'>
                                        </DIV>
                                    </TD>
<?php
                                    }
...
<?php
                                ...
                                $result_row_level4 = db_query($query_row_level4);                                while ($row_level4 = stripslashes_deep($result_bronze->fetch_assoc())) {
...
?>
                                        ...
                                        <DIV style='width: 100%; display: inline-block; vertical-align: top;'>
                                            <INPUT id='level4_street' CLASS='td_data text' MAXLENGTH='64' SIZE='48' TYPE='text' NAME='frm_level4_street' VALUE='<?php print $level4_street;?>' /><BR />
                                            <INPUT id='level4_city' CLASS='td_data text' MAXLENGTH='64' SIZE='48' TYPE='text' NAME='frm_level4_city' VALUE='<?php print $level4_city;?>' /></BR>
                                            <INPUT id='level4_state' CLASS='td_data text' MAXLENGTH='4' SIZE='4' TYPE='text' NAME='frm_level4_state' VALUE='<?php print $level4_state;?>' />
                                            <INPUT TYPE='hidden' NAME='frm_level4_lat' VALUE='<?php print e($row['level4_lat']);?>'>
                                            <INPUT TYPE='hidden' NAME='frm_level4_lng' VALUE='<?php print e($row['level4_lng']);?>'>
                                        </DIV>
                                    </TD>
<?php
                                    }
...
?>
                                        ...
                                        <DIV style='width: 100%; display: inline-block; vertical-align: top;'>
                                            <INPUT id='level5_street' CLASS='td_data text' MAXLENGTH='64' SIZE='48' TYPE='text' NAME='frm_level5_street' VALUE='<?php print $level5_street;?>' /><BR />
                                            <INPUT id='level5_city' CLASS='td_data text' MAXLENGTH='64' SIZE='48' TYPE='text' NAME='frm_level5_city' VALUE='<?php print $level5_city;?>' /></BR>
                                            <INPUT id='level5_state' CLASS='td_data text' MAXLENGTH='4' SIZE='4' TYPE='text' NAME='frm_level5_state' VALUE='<?php print $level5_state;?>' />
                                            <INPUT TYPE='hidden' NAME='frm_level5_lat' VALUE='<?php print e($row['level5_lat']);?>'>
                                            <INPUT TYPE='hidden' NAME='frm_level5_lng' VALUE='<?php print e($row['level5_lng']);?>'>
                                        </DIV>
                                        </TD>
<?php
                                        }
?>
                ...
                <TR CLASS='odd' VALIGN="top">    <!--  6/10/11 -->
                    ...
                    <TD CLASS='td_data text'>
                        <SPAN style='width: 100%; display: block;'>
                            <SELECT id='level6' CLASS='text' NAME="frm_level6" onChange = "this.value=JSfnTrim(this.value); set_command_info(this.value, 'level6_command_data'); showtheDiv('level6_location_data');">    <!--  11/17/10 -->
...
?>
                                            ...
                                            <DIV style='width: 100%; display: inline-block; vertical-align: top;'>
                                                <INPUT id='level6_street' CLASS='td_data text' MAXLENGTH='64' SIZE='48' TYPE='text' NAME='frm_level6_street' VALUE='<?php print $level6_street;?>' /><BR />
                                                <INPUT id='level6_city' CLASS='td_data text' MAXLENGTH='64' SIZE='48' TYPE='text' NAME='frm_level6_city' VALUE='<?php print $level6_city;?>' /></BR>
                                                <INPUT id='level6_state' CLASS='td_data text' MAXLENGTH='4' SIZE='4' TYPE='text' NAME='frm_level6_state' VALUE='<?php print $level6_state;?>' />
                                                <INPUT TYPE='hidden' NAME='frm_level6_lat' VALUE='<?php print e($row['level6_lat']);?>'>
                                                <INPUT TYPE='hidden' NAME='frm_level6_lng' VALUE='<?php print e($row['level6_lng']);?>'>
                                            </DIV>
                                    </TD>
<?php
                                    }
?>
                ...
                <TR CLASS = "even">
                    ...
                    <TD CLASS='td_data text' COLSPAN=3>
                        <TEXTAREA id='description' CLASS='td_data text' NAME="frm_descr" COLS=56 ROWS=5><?php print e($row['description']);?></TEXTAREA>
                    </TD>
                </TR>
                <TR CLASS = "odd">
                    <TD CLASS="td_label text">
                    ...
                    <TD CLASS='td_data text' COLSPAN=3 >
                        <TEXTAREA id='notes' CLASS='td_data text' NAME="frm_notes" COLS=56 ROWS=5><?php print e($row['incident_notes']);?></TEXTAREA>
                    </TD>
                </TR>
                <TR class='spacer'>
        ...
        <DIV id='rightcol' style='position: relative; left: 20px; float: left;'>
            ...
            <DIV id='incs_heading' class='heading' style='text-align: center; width: 100%; border: 1px outset #707070; display: block;'>Incidents to be managed as part of the Major Incident</DIV>
...
<?php
                                ...
                                $result_inc = db_query($query_inc);                                $class="even";
                                while ($row_inc    = stripslashes_deep($result_inc->fetch_assoc())) {
                                    $sel = (in_array($row_inc['id'], $existing_incs, true)) ? "CHECKED": "";
                                    $the_id = $row_inc['id'];
                                    if($class == "even") {$class = "odd";} else {$class = "even";}
                                    print "<SPAN CLASS='" . $class . "' style='width: 100%; display: block;'><input type='checkbox' name='frm_inc[]' style='display: inline;' value='" . $row_inc['id'] . "' " . $sel . " /><SPAN class='link' style='width: 100%; display: inline;' onClick='do_popup(" . $the_id . ");'>" . $row_inc['scope'] . "</SPAN><SPAN>";
                                    }
?>
                            </DIV>
                        </TD>
...
?>
<SCRIPT>
        var marker = createTicMarker(<?php print $row_tick['lat'];?>, <?php print $row_tick['lng'];?>, "Ticket: <?php print e($row_tick['scope']);?><BR />Major Incident: <?php print e($row['name']);?>", <?php print $row_tick['severity'];?>, <?php print $row_tick['id'];?>, <?php print $row['id'];?>, "<?php print e($row_tick['scope']);?>");
        marker.addTo(map);
</SCRIPT>
<?php
        $query_resp = "SELECT *,
...
?>
<SCRIPT>
            var rmarker = createRespMarker(<?php print $row_resp['resp_lat'];?>, <?php print $row_resp['resp_lng'];?>, <?php print $row_resp['resp_id'];?>, <?php print $row['id'];?>, "<?php print e($row_resp['resp_handle']);?>")
            rmarker.addTo(map);
</SCRIPT>
<?php
            }
