...
<BODY onload='pop_eve(<?php print e($row_all['skill_id']);?>)'>
    <DIV id = "outer" style='position: absolute; left: 0px; width: 90%;'>
        <DIV CLASS='header text_large' style = "height:32px; width: 100%; float: none; text-align: center;">
            <SPAN ID='theHeading' CLASS='header text_bold text_big' STYLE='background-color: inherit;'><b>Edit <?php print get_text('Event');?> Attendance for "<?php print e($row['field2']);?> <?php print e($row['field1']);?>"</b></SPAN>
        </DIV>
...
<?php
                            ...
                            $result_eve = db_query($query_eve);                            while ($row_eve = stripslashes_deep($result_eve->fetch_assoc())) {
