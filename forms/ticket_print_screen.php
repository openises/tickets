...
<?php
    ...
    $result = db_query($query, [$id]);    if (!$result->num_rows){    //no tickets? print "error" or "restricted user rights"
...
?>
    ...
    <TR VALIGN="top" style='width: 100%;'>
        <TD CLASS="print_TD, even" ALIGN="left" style='width: 100%;'>
