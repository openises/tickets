...
<SCRIPT TYPE="application/x-javascript" src="./js/wz_tooltip.js"></SCRIPT>
            <DIV id = "outer" style='position: absolute; left: 0px; width: 90%;'>
                <DIV CLASS='header text_large' style = "height:32px; width: 100%; float: none; text-align: center;">
                    <SPAN ID='theHeading' CLASS='header text_bold text_big' STYLE='background-color: inherit;'><b>Viewing <?php print get_text('Member');?> Data for "<?php print e($row['field2']);?> <?php print e($row['field1']);?>"</b></SPAN>
                </DIV>
                <DIV id = "leftcol" style='position: relative; left: 30px; float: left;'>
                    <FORM enctype="multipart/form-data" METHOD="POST" NAME= "mem_edit_form" ACTION="member.php?func=member&goedit=true&id=<?php print e($id);?>&extra=view">
                        <FIELDSET>
                            ...
                            <INPUT MAXLENGTH="<?php print get_fieldsize('1');?>" SIZE="<?php print get_fieldsize('1');?>" TYPE="text" NAME="frm_field1" VALUE="<?php print e($row['field1']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field2"><?php print get_text(get_field_label('defined_fields', 2));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('2');?>" SIZE="<?php print get_fieldsize('2');?>" TYPE="text" NAME="frm_field2" VALUE="<?php print e($row['field2']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field6"><?php print get_text(get_field_label('defined_fields', 6));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('6');?>" SIZE="<?php print get_fieldsize('6');?>" TYPE="text" NAME="frm_field6" VALUE="<?php print e($row['field6']);?>" DISABLED />
                            <BR />
<?php
...
?>
                            ...
                            <INPUT MAXLENGTH="<?php print get_fieldsize('4');?>" SIZE="<?php print get_fieldsize('4');?>" TYPE="text" NAME="frm_field4" VALUE="<?php print e($row['field4']);?>" DISABLED />
                            <BR />
...
?>
                        ...
                        <FIELDSET>
                            ...
                            <INPUT MAXLENGTH="<?php print get_fieldsize('9');?>" SIZE="<?php print get_fieldsize('9');?>" TYPE="text" NAME="frm_field9" VALUE="<?php print e($row['field9']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field10"><?php print get_text(get_field_label('defined_fields', 10));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('10');?>" SIZE="<?php print get_fieldsize('10');?>" TYPE="text" NAME="frm_field10" VALUE="<?php print e($row['field10']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field11"><?php print get_text(get_field_label('defined_fields', 11));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('11');?>" SIZE="<?php print get_fieldsize('11');?>" TYPE="text" NAME="frm_field11" VALUE="<?php print e($row['field11']);?>" DISABLED />
                            <BR />
                            ...
                            <DIV style='position: relative;'>
                                ...
                                <INPUT MAXLENGTH="<?php print get_fieldsize('12');?>" SIZE="<?php print get_fieldsize('12');?>" TYPE="text" NAME="frm_field12" VALUE="<?php print e($row['field12']);?>" DISABLED />
                                <BR />
                                <LABEL for="frm_field13"><?php print get_text(get_field_label('defined_fields', 13));?>:</LABEL>
                                <INPUT MAXLENGTH="<?php print get_fieldsize('13');?>" SIZE="<?php print get_fieldsize('13');?>" TYPE="text" NAME="frm_field13" VALUE="<?php print e($row['field13']);?>" DISABLED />
...
?>
                        ...
                        <FIELDSET>
                            ...
                            <INPUT MAXLENGTH="<?php print get_fieldsize('22');?>" SIZE="<?php print get_fieldsize('22');?>" TYPE="text" NAME="frm_field22" VALUE="<?php print e($row['field22']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field23"><?php print get_text(get_field_label('defined_fields', 23));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('23');?>" SIZE="<?php print get_fieldsize('23');?>" TYPE="text" NAME="frm_field23" VALUE="<?php print e($row['field23']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field24"><?php print get_text(get_field_label('defined_fields', 24));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('24');?>" SIZE="<?php print get_fieldsize('24');?>" TYPE="text" NAME="frm_field24" VALUE="<?php print e($row['field24']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field25"><?php print get_text(get_field_label('defined_fields', 25));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('25');?>" SIZE="<?php print get_fieldsize('25');?>" TYPE="text" NAME="frm_field25" VALUE="<?php print e($row['field25']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field26"><?php print get_text(get_field_label('defined_fields', 26));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('26');?>" SIZE="<?php print get_fieldsize('26');?>" TYPE="text" NAME="frm_field26" VALUE="<?php print e($row['field26']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field27"><?php print get_text(get_field_label('defined_fields', 27));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('27');?>" SIZE="<?php print get_fieldsize('27 ');?>" TYPE="text" NAME="frm_field27" VALUE="<?php print e($row['field27']);?>" DISABLED />
                            <BR />
<?php
                            for($i=35; $i < 67; $i++) {
                                $fieldset = get_fieldset('defined_fields', $i);
...
?>
                        ...
                        <FIELDSET>
                            ...
                            <INPUT MAXLENGTH="<?php print get_fieldsize('28');?>" SIZE="<?php print get_fieldsize('28');?>" TYPE="text" NAME="frm_field28" VALUE="<?php print e($row['field28']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field29"><?php print get_text(get_field_label('defined_fields', 29));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('29');?>" SIZE="<?php print get_fieldsize('29');?>" TYPE="text" NAME="frm_field29" VALUE="<?php print e($row['field29']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field30"><?php print get_text(get_field_label('defined_fields', 30));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('30');?>" SIZE="<?php print get_fieldsize('30');?>" TYPE="text" NAME="frm_field30" VALUE="<?php print e($row['field30']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field31"><?php print get_text(get_field_label('defined_fields', 31));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('31');?>" SIZE="<?php print get_fieldsize('31');?>" TYPE="text" NAME="frm_field31" VALUE="<?php print e($row['field31']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field32"><?php print get_text(get_field_label('defined_fields', 32));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('32');?>" SIZE="<?php print get_fieldsize('32');?>" TYPE="text" NAME="frm_field32" VALUE="<?php print e($row['field32']);?>" DISABLED />
                            <BR />
                            <LABEL for="frm_field33"><?php print get_text(get_field_label('defined_fields', 33));?>:</LABEL>
                            <INPUT MAXLENGTH="<?php print get_fieldsize('33');?>" SIZE="<?php print get_fieldsize('33');?>" TYPE="text" NAME="frm_field33" VALUE="<?php print e($row['field33']);?>" DISABLED />
                            <BR />
<?php
                            for($i=35; $i < 67; $i++) {
                                $fieldset = get_fieldset('defined_fields', $i);
...
?>
                        ...
                        <FIELDSET>
                            ...
                            <TEXTAREA NAME='frm_field20' COLS='48' ROWS='2' class="expand50-200" DISABLED><?php print e($row['field20']);?></TEXTAREA>
                            <BR />
                            <LABEL for="frm_field14"><?php print get_text(get_field_label('defined_fields', 14));?>:</LABEL>
                            <TEXTAREA name="frm_field14" rows="2" cols="48" class="expand50-200" DISABLED><?php print e($row['field14']);?></TEXTAREA>
                            <BR />
<?php
                            for($i=35; $i < 67; $i++) {
                                $fieldset = get_fieldset('defined_fields', $i);
...
//    setup map-----------------------------------//
            ...
            set_fontsizes(viewportwidth, "fullscreen");
                ...
                <FORM NAME='toedit_Form' METHOD="post" ACTION = "member.php?func=member&edit=true&id=<?php print e($id);?>"></FORM>
