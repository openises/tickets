...
function set_size() {
    ...
    middlerowHeight = outerheight * .33;
    colwidth = outerwidth;
    listwidth = outerwidth * .95;
    middlesubcolumnWidth = (middlerowWidth * .98) / 3;
    messageColumnHeight = middlerowHeight * .73;
    ...
    pat_winHeight = outerheight * .70;
    act_winHeight = outerheight * .70;
    disp_listheight = outerheight * .70;
    var alertswidth = (broadcast == 1) ? middlesubcolumnWidth * .9 : middlesubcolumnWidth * 1.8;
    ...
    if($('ticketlist')) {$('ticketlist').style.height = listHeight + "px";}
    if($('ticketheader')) {$('ticketheader').style.width = outerwidth + "px";}
    if($('ticketlist')) {$('ticketlist').style.width = outerwidth + "px";}
    if($('the_list')) {$('the_list').style.width = outerwidth + "px";}
    ...
    if($('imwrapper')) {$('imwrapper').style.width = (middlesubcolumnWidth * .9) + "px";}
...
function show_disp_line(id, the_row, unit_id) {
    ...
    setDirections(lats[id], lngs[id], theLat, theLng, "", "", "en_US", unit_id, "Line 206");
    }
...
function get_auxForm(id, theTitle, theFunc) {
    window.tick_id = id;
    var randomnumber=Math.floor(Math.random()*99999999);
    ...
    switch(theFunc) {
        ...
        var url = './ajax/mail_form.php?func=all_units&version=' + randomnumber + '&q=' + sess_id;
        alert(url);
        var theWidth = window.mess_winWidth;
        var theHeight = window.mess_winHeight;
        break;
...
?>    </DIV>
    <DIV id='leftcol' style='width: 100%; text-align: center; display: block;'>
        ...
        <DIV class="scrollableContainer" id='ticketlist' style='border: 1px outset #707070;'>
            <DIV class="scrollingArea" id='the_list' style=' max-height: 98%;'><CENTER><IMG src='./images/owmloading.gif'></CENTER></DIV>
        </DIV>
        <BR />
...
?>
                <DIV id='imwrapper' style='display: inline-block; width: 30%; height: 100%; vertical-align: top; border: 1px outset #707070; float: right; padding-left: 5px; padding-right: 5px;'>
                    ...
                    <DIV id='has_messages' style='width: 99%; height: 60%; background-color: #000000; color: #FFFFFF; overflow-y: scroll; z-index: 9999;'></DIV>
...
?>
    ...
    <DIV id='detail' style='position: absolute; right: 0px; top: 0px; width: 80%; height: 80%; display: none; border: 7px outset #707070; z-index: 999999; background-color: <?php print $divBG;?>;'>
        ...
        <DIV id='ticket_div' style='position: relative; top: 0px; left: 0px; height: 95%; line-height: 20px; width: 100%; display: inline-block;'>
            ...
            <DIV id='ticket_details' style='max-height: 45%; overflow-y: auto; width: 100%; background-color: <?php print $divBG;?>;'></DIV>
            <DIV id='assigns_header' class='header text_biggest text_center' style='vertical-align: top; width: 100%; display: inline-block; background-color: <?php print $divBG;?>;'>Assignments</DIV>
...
listHeight = outerheight * .35;
middlerowWidth = outerwidth;
middlerowHeight = outerheight * .30;
colwidth = outerwidth;
listwidth = outerwidth * .95;
middlesubcolumnWidth = (middlerowWidth * .98) / 3;
