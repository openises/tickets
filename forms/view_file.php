...
$file_id = (array_key_exists('id', $_GET)) ? sanitize_int($_GET['id']): 0;
...
<SCRIPT TYPE="application/x-javascript" SRC="../js/jss.js"></SCRIPT>
		...
		<BODY>	
			<DIV id='topbar' style='position: fixed; top: 0px; left: 0px; width: 99%; z-index: 999; background-color: #DEDEDE; border: 2px outset #CECECE;'>			
				<DIV class='tablehead text_large' style='width: 100%; float: left; z-index: 999'><b>View <?php print get_text('File');?> for "<?php print e($row['field2']);?> <?php print e($row['field1']);?>"</b>			
			...
			<DIV ID='outer' style='align: center; position: relative; top: 50px; left: 0px; z-index: 998;'>
				<DIV id='leftcol' style='position: absolute; top: 10px; left: 0px; border: 2px outset #FFFFFF; padding: 20px; z-index: 2; background-color: #FEF7D6;'>
					<DIV style='width: 100%;'><A CLASS='td_label' HREF="#" TITLE="File Name - Click to Open">File</A>:&nbsp;<A HREF="../<?php print $realfile;?>"><I><U><?php print e($row_f['shortname']);?></U></I></A></DIV><BR />
					<FORM enctype="multipart/form-data" METHOD="POST" NAME= "file_edit_Form" ACTION="#">
						...
						<LEGEND>View <?php print get_text('Stored File');?></LEGEND>
							...
							<INPUT TYPE="text" NAME="frm_file" SIZE="48" VALUE="<?php print e($row_f['shortname']);?>" READONLY>
							<BR />
							<BR />
							<LABEL for="frm_description"><?php print get_text('File');?> Description:</LABEL>
							<INPUT TYPE="text" NAME="frm_description" MAXLENGTH='48' SIZE="48" VALUE="<?php print e($row_f['description']);?>" READONLY>
							<BR />
						</FIELDSET>
					</FORM>						
				</DIV>
