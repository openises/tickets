		...
		<TR CLASS="even" VALIGN="top"><TD COLSPAN="2" ALIGN="CENTER"><FONT SIZE="+1">Table 'unit_types' - View Entry</FONT></TD></TR>
		<TR><TD>&nbsp;</TD></TR>
		...
		<TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right">Icon:</TD>			<TD><IMG ID='ID3' SRC="<?php print './icons/sm_' . $row['icon'];?>" STYLE="visibility:visible;"></TD></TR>
