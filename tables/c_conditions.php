...
?>
		...
		<TR CLASS="even" VALIGN="top">
			<TD COLSPAN="2" ALIGN="CENTER"><FONT SIZE="+1">Table 'Conditions' - Add New Entry</FONT></TD>
		</TR>
		<TR>
			<TD>&nbsp;</TD>
		</TR>
		<TR VALIGN="baseline" CLASS="odd">
			<TD CLASS="td_label" ALIGN="right">Type name:</TD>
			<TD>
				<INPUT ID="ID1" CLASS="dirty" MAXLENGTH="16" SIZE="16" type="text" NAME="frm_title" VALUE="" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN>
			</TD>
		</TR>
		...
		<TR VALIGN="top" CLASS="odd">
			<TD CLASS="td_label" ALIGN="right">Icon:</TD>
			<TD>
				<IMG ID='ID3' SRC="theIcons[0]" STYLE="visibility:hidden;">
			</TD>
		</TR>
		<TR CLASS="even">
			<TD>
