...
function validate_form(myform) {    // reject empty form elements
    ...
    myform.submit();
        ...
        <TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right">Surname:</TD>
            <TD><INPUT ID="ID1" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_surname" VALUE="<?php print e($row['surname']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right">Fornames:</TD>
            <TD><INPUT ID="ID2" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_forenames" VALUE="<?php print e($row['forenames']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right">Address:</TD>
            <TD><INPUT ID="ID3" CLASS="dirty" MAXLENGTH="128" SIZE="48" type="text" NAME="frm_address" VALUE="<?php print e($row['address']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        ...
        <TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right">Identifier:</TD>
            <TD><INPUT ID="ID6" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_person_identifier" VALUE="<?php print e($row['person_identifier']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right">Email:</TD>
            <TD><INPUT ID="ID7" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_email" VALUE="<?php print e($row['email']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right">Home phone:</TD>
            <TD><INPUT ID="ID8" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_homephone" VALUE="<?php print e($row['homephone']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right">Work phone:</TD>
            <TD><INPUT ID="ID9" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_workphone" VALUE="<?php print e($row['workphone']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right">Cellphone:</TD>
            <TD><INPUT ID="ID10" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_cellphone" VALUE="<?php print e($row['cellphone']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right">Next of Kin Name:</TD>
            <TD><INPUT ID="ID11" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_next_of_kin_name" VALUE="<?php print e($row['next_of_kin_name']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right">Next of Kin Address:</TD>
            <TD><INPUT ID="ID12" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_next_of_kin_address" VALUE="<?php print e($row['next_of_kin_address']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right">Next of Kin Home phone:</TD>
            <TD><INPUT ID="ID13" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_next_of_kin_homephone" VALUE="<?php print e($row['next_of_kin_homephone']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right">Next of Kin Work phone:</TD>
            <TD><INPUT ID="ID14" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_next_of_kin_workphone" VALUE="<?php print e($row['next_of_kin_workphone']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right">Next of Kin Cellphone:</TD>
            <TD><INPUT ID="ID15" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_next_of_kin_cellphone" VALUE="<?php print e($row['next_of_kin_cellphone']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right">AR Callsign:</TD>
            <TD><INPUT ID="ID16" CLASS="dirty" MAXLENGTH="48" SIZE="48" type="text" NAME="frm_amateur_radio_callsign" VALUE="<?php print e($row['amateur_radio_callsign']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right">Notes:</TD>
            <TD><TEXTAREA ID="ID17" name="frm_person_notes" rows="6" cols="48" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"><?php print e($row['person_notes']);?></TEXTAREA> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right">Capabilities:</TD>
            <TD><TEXTAREA ID="ID18" name="frm_person_capabilities" rows="6" cols="48" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"><?php print e($row['person_capabilities']);?></TEXTAREA> <SPAN class='warn' >text</SPAN></TD></TR>
        <TR>
