...
?>
        ...
        <INPUT TYPE="hidden" NAME="frm_icon"     VALUE="<?php print e($row['icon']);?>" />
    ...
    <TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right">Type name:</TD>
        <TD><INPUT  ID="ID1" CLASS="dirty" MAXLENGTH="16" SIZE="16" type="text" NAME="frm_title" VALUE="<?php print e($row['title']);?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value)"> <SPAN class='warn' >text</SPAN></TD></TR>
    ...
    <TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right">Icon:</TD>
        <TD><IMG ID='ID3' SRC="<?php print './rm/roadinfo_icons/' . e($row['icon']);?>"></TD></TR>
