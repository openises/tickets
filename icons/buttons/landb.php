...
?>	
		...
		<TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="left">Apply to:</TD>
			<TD ALIGN='left' CLASS="td_label"  STYLE = 'white-space:nowrap;' >
				...
				<SPAN STYLE="border:1px; width:20%">&nbsp;&nbsp;Regions&nbsp;&raquo;&nbsp;<INPUT  TYPE= "checkbox" NAME="box_use_with_r"  onClick = "this.form.frm_use_with_r.value=1"/></SPAN>
				</TD>
			</TR>
...
?>
		...
		<TR CLASS="even" ><TD CLASS="td_label" ALIGN="left">Apply to:</TD>
			<TD ALIGN='left' CLASS="td_label" >
				...
				<SPAN STYLE="border:1px; width:20%">&nbsp;&nbsp;Regions&nbsp;&raquo;&nbsp;<INPUT  TYPE= "checkbox" 		NAME="box_use_with_r"	<?php print $use_w_r;?> onClick = "this.form.frm_use_with_r.value=toggle(this.value)" <?php print $dis;?>/></SPAN>
				</TD>
			</TR>
