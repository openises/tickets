...
$row = ($result->num_rows>0)? stripslashes_deep($result->fetch_assoc()): false;        // 6/23/2013
...
$result = db_query($query);
$act_row =  ($result->num_rows>0)? stripslashes_deep($result->fetch_assoc()): false;
