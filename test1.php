...
//    $a = $wgs84->maj;
  ...
  class OSRef {
	...
	dump($this->northing);
	  ...
	  $temp = sprintf("%s%s%03d%03d", $firstLetter, $secondLetter, $e, $n);
		dump($temp);
...
dump (LLtoOSGB(52.0, -1.0));
/*
int(49)		LatLng($lat, $lng) 
int(149)	WGS84ToOSGB36()
int(699)	RefEll($maj, $min)
int(699)	RefEll($maj, $min)
int(204)	toOSRef()
int(699)	RefEll($maj, $min)
int(400)	OSRef($easting, $northing)
int(425)	toSixFigureString()
