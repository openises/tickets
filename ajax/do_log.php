...
$info = (array_key_exists('info', $_GET)) ? sanitize_string($_GET['info']) : "";
$facility_id = (array_key_exists('fac_id', $_GET)) ? sanitize_int($_GET['fac_id']) : 0;
$rec_facility_id = (array_key_exists('rec_fac_id', $_GET)) ? sanitize_int($_GET['rec_fac_id']) : 0;
