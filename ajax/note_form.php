...
$output = "<BR /><BR />";
$output .= "<SPAN CLASS='text text_large text_bold text_center' style='width: 100%; display: block;'>Enter note text to add to ticket id " . e($ticket_id) . "</SPAN><BR />";
$output .= "<FORM NAME='frm_note' METHOD='post' ACTION='./ajax/form_post.php?q=". e($sess_id) . "&function=note'>";
...
$output .= "<INPUT TYPE = 'hidden' NAME = 'frm_ticket_id' VALUE='" . e($ticket_id) . "' />";
