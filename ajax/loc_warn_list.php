...
$in_lat = sanitize_string($_GET['lat']);
$in_lng = sanitize_string($_GET['lng']);
...
if($out_arr[0] == "No Warnings Found") {
    ...
    foreach($out_arr as $output) {
        $print .= "<TR style='background-color: " . $bgcol . ";' onClick='wl_win(" . intval($output[0]) . ");'>";
        $print .= "<TD style='color: #000000;'>" . e($output[1]) . "</TD>";
        $print .= "<TD style='color: #000000;'>" . e($output[2]) . "</TD>";
        $print .= "<TD style='color: #000000;'>" . e($output[3]) . "</TD>";
        $print .= "<TD style='color: #000000;'>" . e($output[4]) . "</TD>";
        $print .= "<TD style='color: #000000;'>" . e($output[6]) . "</TD>";
        $print .= "<TD style='color: #000000;'>" . e($output[8]) . "</TD>";
        $print .= "</TR>";
