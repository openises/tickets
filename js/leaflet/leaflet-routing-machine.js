...
(function() {
	...
	L.Routing.Itinerary = L.Control.extend({
		...
		_createAlternative: function(alt, i) {
			...
			document.textDirections = alt.name + ", " + alt.summary.totalDistance + ", " + alt.summary.totalTime + "\r\n";
			L.DomEvent.addListener(altDiv, 'click', this._onAltClicked, this);
			this.on('routeselected', this._selectAlt, this);
			altDiv.appendChild(this._createItineraryContainer(alt));
			var theInstructions = alt.instructions;
			for(var z = 0; z < theInstructions.length; z++) {
				document.textDirections += this._formatter.formatDistance(theInstructions[z].distance) + " " + this._formatter.formatInstruction(theInstructions[z], z) + "\r\n";
				}
			return altDiv;
		},
