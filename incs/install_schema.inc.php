...
$INSTALL_SCHEMA_TABLES = array(
  ...
  `_from` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `_on` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT=\'Allows for variable facility types\'',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ID` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT=\'Incident types\'',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ID` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT=\'Log of station actions\'',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT=\'login authentication\'',
  ...
  `field22` text DEFAULT NULL,
  `field23` text DEFAULT NULL,
  `field24` text DEFAULT NULL,
  `field25` text DEFAULT NULL,
  `field26` text DEFAULT NULL,
  `field27` text DEFAULT NULL,
  `field28` text DEFAULT NULL,
  `field29` text DEFAULT NULL,
  `field30` text DEFAULT NULL,
  `field31` text DEFAULT NULL,
  `field32` text DEFAULT NULL,
  `field33` text DEFAULT NULL,
  `field34` text DEFAULT NULL,
  `field35` text DEFAULT NULL,
  `field36` text DEFAULT NULL,
  `field37` text DEFAULT NULL,
  `field38` text DEFAULT NULL,
  `field39` text DEFAULT NULL,
  `field40` text DEFAULT NULL,
  `field41` text DEFAULT NULL,
  `field42` text DEFAULT NULL,
  `field43` text DEFAULT NULL,
  `field44` text DEFAULT NULL,
  `field45` text DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ID` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT=\'Lines and borders\'',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ID` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT=\'Map markup categories\'',
    'modules' => 'CREATE TABLE `modules` (
  `id` bigint(8) NOT NULL AUTO_INCREMENT,
  `mod_name` varchar(26) NOT NULL,
  `mod_status` varchar(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT=\'Optional modules to load\'',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT=\'data from membership database\'',
  ...
  `_from` varchar(16) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT=\'Main table for roads information\'',
  ...
  `id` int(4) NOT NULL AUTO_INCREMENT,
  `fieldid` varchar(48) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT=\'settings for statistics screen\'',
  ...
  `_by` int(7) NOT NULL COMMENT \'by\',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT=\'Allows for variable unit types\'',
  ...
  `fueltype` enum(\'Petrol\',\'Diesel\',\'LPG\',\'EV\',\'HEV\',\'PHEV\') NOT NULL,
