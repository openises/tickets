...
2/10/12 Unit and Handle caption corrections
*/
...
?>
	...
	side_bar_html += "<TR class='even'>	<TD></TD><TD ALIGN='left'><B><?php print get_text("Handle");?></B></TD><TD ALIGN='left'><B><?php print get_text("Unit");?></B></TD><TD ALIGN='left'><B>Dispatch</B></TD><TD ALIGN='left'><B>Status</B></TD><TD ALIGN='left'><B>M</B></TD><TD ALIGN='left'><B>As of</B></TD></TR>";
	var gmarkers = [];
	var infoTabs = [];
	var which;
