					...
					<TR>
						<TD width='50%'>
							<TABLE ID = 'sidebar' BORDER = 0 WIDTH='98%'>
								<TR class='even'>
									<TD colspan=99 ALIGN='center'><B>Units (<DIV id="num_units" style="display: inline;"></DIV>)</B>
									</TD>
								</TR>
								<TR class='odd'>
...
?>
						...
						<TD WIDTH = '50%'>
							<TABLE ID = 'MAP' BORDER=0>
								...
								<TR class = 'odd'>
									<TD ALIGN='center' class='td_label'><SPAN CLASS="legend" STYLE="font-size: 14px; text-align: center; vertical-align: middle; width: <?php print get_variable('map_width');?>-25px;"><B>Units Legend:</B></SPAN>
									</TD>
								</TR>	<!-- 3/15/11 -->
								<TR class = 'even'>
									<TD ALIGN='center'>
